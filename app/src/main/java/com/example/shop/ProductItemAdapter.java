...
public class ProductItemAdapter
        extends RecyclerView.Adapter<ProductItemAdapter.ViewHolder>
        implements Filterable {
    // Member variables.
    private ArrayList<ProductItem> mShoppingData;
    private ArrayList<ProductItem> mSoppingDataAll;
    ...
    @Override
    public ProductItemAdapter.ViewHolder onCreateViewHolder(
    ...
    public void onBindViewHolder(ProductItemAdapter.ViewHolder holder, int position) {
        // Get current sport.
        ProductItem currentItem = mShoppingData.get(position);
    ...
    private Filter shoppingFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if(charSequence == null || charSequence.length() == 0) {
                ...
                for(ProductItem item : mSoppingDataAll) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindTo(ProductItem currentItem){
